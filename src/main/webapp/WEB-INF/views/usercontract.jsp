...
<div class="container">
    ...
    <form:form modelAttribute="contractDto" method="get" cssStyle="margin-top: 20px">

        <div class="form-group row">
            <form:label path="phone"  cssClass="col-sm-2 col-form-label">Phone number</form:label>
            <div class="col-sm-10">
                <form:input path="phone" cssClass="form-control"  readonly="true"/>
            </div>
        </div>
        <div class="form-group row">
            <form:label path="clientDto.firstName"  cssClass="col-sm-2 col-form-label">FirstName</form:label>
            <div class="col-sm-10">
                <form:input path="clientDto.firstName" cssClass="form-control"  readonly="true"/>
            </div>
        </div>
        <div class="form-group row">
            <form:label path="clientDto.lastName"  cssClass="col-sm-2 col-form-label">LastName</form:label>
            <div class="col-sm-10">
                <form:input path="clientDto.lastName" cssClass="form-control"  readonly="true"/>
            </div>
        </div>
        <div class="form-group row">
            <form:label path="clientDto.email"  cssClass="col-sm-2 col-form-label">Email</form:label>
            <div class="col-sm-10">
                <form:input path="clientDto.email" cssClass="form-control"  readonly="true"/>
            </div>
        </div>

        <div class="form-group row">
            <form:label path="tariffDto.tariff"  cssClass="col-sm-2 col-form-label">Tariff</form:label>
            <div class="col-sm-10">
                <form:input path="tariffDto.tariff"   cssClass="form-control"   readonly="true"/>
            </div>
        </div>
